...
const HempFlower = () => {
  ...
  const hempProducts = products.filter(
    (product): product is ProductType => product.category === "Hemp Flower"
  );
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-accent to-white">
      ...
      <div className="container mx-auto px-2 md:px-4 flex-grow">
        <h1 className="text-2xl font-bold mb-4 pt-4">Hemp Flower</h1>
